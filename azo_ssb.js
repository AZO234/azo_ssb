...
azo_ssb.prototype.change_links = function(links) {
  ...
  if(this.twitter_account_via == '') {
    if(this.twitter_account_follow == '') {
      ...
      this.twitter_link = 'https://twitter.com/intent/tweet?text=' + this.entitle + '&url=' + this.enURL + '&hashtags=' + this.twitter_hashtag + '&related="' + this.twitter_account_follow;
    }
  } else {
    if(this.twitter_account_follow == '') {
      this.twitter_link = 'https://twitter.com/intent/tweet?text=' + this.entitle + '&url=' + this.enURL + '&hashtags=' + this.twitter_hashtag + '&via=' + this.twitter_account_via;
    } else {
      this.twitter_link = 'https://twitter.com/intent/tweet?text=' + this.entitle + '&url=' + this.enURL + '&hashtags=' + this.twitter_hashtag + '&via=' + this.twitter_account_via + '&related="' + this.twitter_account_follow;
    }
  }
...
azo_ssb.prototype.add_btn3 = function(setting, tr, nameid, imgurl, snsname, title, link, cb) {
  var td = document.createElement('td');
